...
const FALLBACK_RELEASE = {
  tagName: "v0.15.1-beta.5",
  prerelease: true,
  publishedAt: null,
  url: `https://github.com/${REPOSITORY}/releases/tag/v0.15.1-beta.5`,
  assetNames: [
    "PI-Desktop-Setup-0.15.1-beta.5.exe",
    "PI-Desktop-Portable-0.15.1-beta.5.exe",
    "PI-Desktop-0.15.1-beta.5-arm64.dmg",
    "PI-Desktop-0.15.1-beta.5-arm64-mac.zip",
    "PI-Desktop-0.15.1-beta.5-x64.dmg",
    "PI-Desktop-0.15.1-beta.5-x64-mac.zip",
    "PI-Desktop-0.15.1-beta.5.AppImage",
    "pi-desktop_0.15.1-beta.5_amd64.deb",
    "pi-desktop-0.15.1-beta.5-x86_64.rpm",
    "PI-Desktop-0.15.1-beta.5-linux-x64.asar",
  ],
};
