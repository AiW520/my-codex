...
| `check-release-docs.mjs` | `pnpm check:release-docs` | Verify version surfaces agree and the changelog, its test list, and both README release lines match the stable catalog version |
