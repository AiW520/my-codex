...
sklm: {
    ...
    presetTuziCodex: "Tuzi Store Codex subscription",
    presetGacCodex: "GAC Codex subscription",
    tuziOnboardingEyebrow: "Choose your connection",
    tuziOnboardingTitle: "Connect a Tuzi service",
    tuziOnboardingSubtitle: "Pick a product to load its endpoint and discover the models available to your key.",
    tuziOnboardingSecurity: "API keys stay in the system keychain",
    tuziOnboardingLater: "Later",
    tuziOnboardingOther: "Other provider",
    tuziProductApiDescription: "Flexible API access for compatible chat models.",
    tuziProductCodexDescription: "A ready-to-use Codex subscription from Tuzi Store.",
    tuziProductGacDescription: "Codex subscription access through GAC Code.",
