...
sklm: {
    ...
    presetTuziCodex: "Tuzi Store Codex aboneliği",
    presetGacCodex: "GAC Codex aboneliği",
    tuziOnboardingEyebrow: "Bağlantınızı seçin",
    tuziOnboardingTitle: "Bir Tuzi hizmetine bağlanın",
    tuziOnboardingSubtitle: "Anahtarınız için uç noktayı ve kullanılabilir modelleri yüklemek üzere bir ürün seçin.",
    tuziOnboardingSecurity: "API anahtarları sistem anahtar zincirinde tutulur",
    tuziOnboardingLater: "Daha sonra",
    tuziOnboardingOther: "Başka sağlayıcı",
    tuziProductApiDescription: "Uyumlu sohbet modelleri için esnek API erişimi.",
    tuziProductCodexDescription: "Tuzi Store'dan kullanıma hazır Codex aboneliği.",
    tuziProductGacDescription: "GAC Code üzerinden Codex aboneliği erişimi.",
