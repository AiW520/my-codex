...
sklm: {
    ...
    "presetTuziCodex": "Suscripción Codex de Tuzi Store",
    "presetGacCodex": "Suscripción Codex de GAC",
    "tuziOnboardingEyebrow": "Elige tu conexión",
    "tuziOnboardingTitle": "Conecta un servicio Tuzi",
    "tuziOnboardingSubtitle": "Elige un producto para cargar su endpoint y descubrir los modelos disponibles para tu clave.",
    "tuziOnboardingSecurity": "Las claves API se guardan en el llavero del sistema",
    "tuziOnboardingLater": "Más tarde",
    "tuziOnboardingOther": "Otro proveedor",
    "tuziProductApiDescription": "Acceso API flexible para modelos de chat compatibles.",
    "tuziProductCodexDescription": "Suscripción Codex lista para usar de Tuzi Store.",
    "tuziProductGacDescription": "Acceso de suscripción Codex mediante GAC Code.",
