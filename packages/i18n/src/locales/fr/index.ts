...
import { workbenchFr } from "../../workbench-copy.js";
...
sklm: {
    ...
    "presetOpenai": "OpenAI",
    "presetTuziApi": "API Tuzi",
    "presetTuziCodex": "Abonnement Codex Tuzi Store",
    "presetGacCodex": "Abonnement Codex GAC",
    "tuziOnboardingEyebrow": "Choisissez votre connexion",
    "tuziOnboardingTitle": "Connecter un service Tuzi",
    "tuziOnboardingSubtitle": "Choisissez un produit pour charger son endpoint et découvrir les modèles disponibles pour votre clé.",
    "tuziOnboardingSecurity": "Les clés API restent dans le trousseau système",
    "tuziOnboardingLater": "Plus tard",
    "tuziOnboardingOther": "Autre fournisseur",
    "tuziProductApiDescription": "Accès API flexible pour les modèles de chat compatibles.",
    "tuziProductCodexDescription": "Abonnement Codex prêt à l'emploi de Tuzi Store.",
    "tuziProductGacDescription": "Accès à un abonnement Codex via GAC Code.",
