...
import { workbenchZhCN } from "../../workbench-copy.js";
...
sklm: {
    ...
    presetOpenai: "OpenAI",
    presetTuziApi: "兔子 API",
    presetTuziCodex: "兔小店 Codex 订阅",
    presetGacCodex: "GAC Codex 订阅",
    tuziOnboardingEyebrow: "选择连接方式",
    tuziOnboardingTitle: "连接兔子服务",
    tuziOnboardingSubtitle: "选择产品后会自动填入接口地址，并根据你的密钥获取可用模型。",
    tuziOnboardingSecurity: "API 密钥仅保存在系统密钥链中",
    tuziOnboardingLater: "稍后配置",
    tuziOnboardingOther: "配置其它供应商",
    tuziProductApiDescription: "适用于兼容聊天模型的灵活 API 服务。",
    tuziProductCodexDescription: "来自兔小店的即开即用 Codex 订阅。",
    tuziProductGacDescription: "通过 GAC Code 使用 Codex 订阅。",
