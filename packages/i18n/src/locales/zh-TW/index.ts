...
sklm: {
    ...
    presetTuziCodex: "兔小店 Codex 訂閱",
    presetGacCodex: "GAC Codex 訂閱",
    tuziOnboardingEyebrow: "選擇連線方式",
    tuziOnboardingTitle: "連線兔子服務",
    tuziOnboardingSubtitle: "選擇產品後會自動填入介面地址，並根據你的密鑰取得可用模型。",
    tuziOnboardingSecurity: "API 密鑰僅保存在系統鑰匙圈",
    tuziOnboardingLater: "稍後設定",
    tuziOnboardingOther: "設定其他供應商",
    tuziProductApiDescription: "適用於相容聊天模型的彈性 API 服務。",
    tuziProductCodexDescription: "來自兔小店的即用型 Codex 訂閱。",
    tuziProductGacDescription: "透過 GAC Code 使用 Codex 訂閱。",
