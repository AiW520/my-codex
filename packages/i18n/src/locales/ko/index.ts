...
sklm: {
    ...
    presetTuziCodex: "Tuzi Store Codex 구독",
    presetGacCodex: "GAC Codex 구독",
    tuziOnboardingEyebrow: "연결 선택",
    tuziOnboardingTitle: "Tuzi 서비스 연결",
    tuziOnboardingSubtitle: "제품을 선택하면 엔드포인트를 불러오고 키에서 사용할 수 있는 모델을 검색합니다.",
    tuziOnboardingSecurity: "API 키는 시스템 키체인에 보관됩니다",
    tuziOnboardingLater: "나중에",
    tuziOnboardingOther: "다른 공급자",
    tuziProductApiDescription: "호환되는 채팅 모델을 위한 유연한 API 액세스.",
    tuziProductCodexDescription: "Tuzi Store의 바로 사용할 수 있는 Codex 구독.",
    tuziProductGacDescription: "GAC Code를 통한 Codex 구독 액세스.",
